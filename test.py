...
def read_serial_data(serial_port = '/dev/ttyUSB0' , baud_rate = 115200, command='$PLSC,VER*CK', keyword='$GNGGA'):
...
def connect_to_caster(caster_ip = "91.198.76.2", caster_port = 8080, stream_identifier = "NAWGEO_POJ_3_1", username = "Kavin", password = "Kavin@4236"):
